Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '8.1.0'
  end
  ...
  s.subspec 'FBAudienceNetwork' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'FBAudienceNetwork', '~> 6.3.0'
  end
  ...
  s.subspec 'Fyber' do |b|
    b.source_files = 'CASMediation/CASFyberProvider.swift'
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'Fyber_Marketplace_SDK', '~> 7.8.1'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'IronSourceSDK', '7.1.1.0'
  end
  ...
  s.subspec 'StartApp' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'StartAppSDK', '~> 4.6.1'
  end

  s.subspec 'Tapjoy' do |b|
    b.source_files = 'CASMediation/Tapjoy/CASTapjoyProvider.swift',
                     'CASMediation/Tapjoy/CASTapjoyBridge.h'
    b.private_header_files = 'CASMediation/Tapjoy/CASTapjoyBridge.h'
    b.preserve_paths = 'CASMediation/Tapjoy/module.modulemap'
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'TapjoySDK', '~> 12.7.1'
  end
  ...
  s.subspec 'Main' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/MoPub', "#{s.version}"
  end
end
