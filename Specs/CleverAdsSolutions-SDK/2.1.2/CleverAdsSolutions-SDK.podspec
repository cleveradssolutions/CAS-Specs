Pod::Spec.new do |s|
  ...
  s.subspec 'YandexAds' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'YandexMobileAds', '~> 4.0.0'
  end

  s.subspec 'YandexAdsProxy' do |b|
    b.source_files = 'CASMediation/CASYandexProvider.swift'
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'YandexMobileAdsProxy', '~> 4.0.0'
  end
  ...
  s.subspec 'MoPub' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'mopub-ios-sdk/Core', '~> 5.16.2'
  end
  ...
  s.subspec 'Fyber' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'Fyber_Marketplace_SDK', '~> 7.8.2'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'IronSourceSDK', '~> 7.1.4.0'
  end
