Pod::Spec.new do |s|
  ...
  s.subspec 'AppLovin' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'AppLovinSDK', '~> 10.1.1'
  end
  ...
  s.subspec 'YandexAds' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'YandexMobileAds', '~> 4.1.0'
  end
  ...
  s.subspec 'MyTarget' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'myTargetSDK', '~> 5.10.3'
  end
  ...
  s.subspec 'FairBid' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'FairBidSDK', '~> 3.13.0'
  end
  ...
  s.subspec 'StartApp' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'StartAppSDK', '~> 4.6.2'
  end
