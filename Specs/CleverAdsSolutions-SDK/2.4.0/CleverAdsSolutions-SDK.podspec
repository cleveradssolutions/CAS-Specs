Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '~> 8.7'
  end
  ...
  s.subspec 'AppLovin' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'AppLovinSDK', '~> 10.3.2'
  end
  ...
  s.subspec 'YandexAds' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'YandexMobileAds', '~> 4.2.0'
  ...
  s.subspec 'FairBid' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'FairBidSDK', '~> 3.16.0'
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'MintegralAdSDK/BidBannerAd', '~> 6.9.4'
    b.dependency 'MintegralAdSDK/BidInterstitialVideoAd', '~> 6.9.4'
    b.dependency 'MintegralAdSDK/BidRewardVideoAd', '~> 6.9.4'
  end
