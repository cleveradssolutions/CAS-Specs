Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '~> 8.8'
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'MintegralAdSDK/BidBannerAd', '~> 6.9.5'
    b.dependency 'MintegralAdSDK/BidInterstitialVideoAd', '~> 6.9.5'
    b.dependency 'MintegralAdSDK/BidRewardVideoAd', '~> 6.9.5'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'CleverAdsSolutions-SDK/Base', "#{s.version}"
    b.dependency 'IronSourceSDK', '~> 7.1.7'
  end
