Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Promo/Base', "#{s.version}"
    b.dependency 'Google-Mobile-Ads-SDK', '~> 8.11'
  end
  ...
  s.subspec 'FBAudienceNetwork' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Promo/Base', "#{s.version}"
    b.dependency 'FBAudienceNetwork', '~> 6.7.0'
  end
  ...
  s.subspec 'MyTarget' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Promo/Base', "#{s.version}"
    b.dependency 'myTargetSDK', '~> 5.14.0'
  end

  s.subspec 'FairBid' do |b|
    b.source_files = 'CASMediation/CASFairBidProvider.swift'
    b.dependency 'CleverAdsSolutions-Promo/Base', "#{s.version}"
    b.dependency 'FairBidSDK', '~> 3.19.0'
  end

  s.subspec 'Vungle' do |b|
    b.source_files = 'CASMediation/CASVungleProvider.swift'
    b.dependency 'CleverAdsSolutions-Promo/Base', "#{s.version}"
    b.dependency 'VungleSDK-iOS', '~> 6.10.3'
  end

  s.subspec 'Mintegral' do |b|
    b.source_files = 'CASMediation/CASMintegralProvider.swift'
    b.dependency 'CleverAdsSolutions-Promo/Base', "#{s.version}"
    b.dependency 'MintegralAdSDK/BidBannerAd', '~> 7.0.2'
    b.dependency 'MintegralAdSDK/BidInterstitialVideoAd', '~> 7.0.2'
    b.dependency 'MintegralAdSDK/BidRewardVideoAd', '~> 7.0.2'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Promo/Base', "#{s.version}"
    b.dependency 'IronSourceSDK', '~> 7.1.11'
  end
