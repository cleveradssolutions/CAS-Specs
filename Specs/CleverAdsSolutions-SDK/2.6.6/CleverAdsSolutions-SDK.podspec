Pod::Spec.new do |s|
  ...
  s.subspec 'InMobi' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base', "#{s.version}"
    b.dependency 'InMobiSDK/Core', '~> 10.0.2'
  end
  ...
  s.subspec 'SuperAwesome' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base', "#{s.version}"
    b.dependency 'SuperAwesome', '8.1.5'
  ...
  s.subspec 'MyTarget' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base', "#{s.version}"
    b.dependency 'myTargetSDK', '~> 5.15.0'
  end
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base', "#{s.version}"
    b.dependency 'Ads-Global/BUAdSDK', '~> 4.3.0.2'
    b.dependency 'Ads-Global/Domestic', '~> 4.3.0.2'
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base', "#{s.version}"
    b.dependency 'MintegralAdSDK/BidBannerAd', '~> 7.1.0'
    b.dependency 'MintegralAdSDK/BidInterstitialVideoAd', '~> 7.1.0'
    b.dependency 'MintegralAdSDK/BidNewInterstitialAd', '~> 7.1.0'
    b.dependency 'MintegralAdSDK/BidRewardVideoAd', '~> 7.1.0'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base', "#{s.version}"
    b.dependency 'IronSourceSDK', '~> 7.2.1'
  end
