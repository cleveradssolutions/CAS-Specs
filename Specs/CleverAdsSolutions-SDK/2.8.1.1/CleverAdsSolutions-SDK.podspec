Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://github.com/cleveradssolutions/CAS-iOS/releases/download/2.8.1/CleverAdsSolutions.tar.gz" }
  s.platform              = :ios
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '~> 9.5.0'
  end
  ...
  s.subspec 'AppLovin' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'AppLovinSDK', '~> 11.4.1'
  end
  ...
  s.subspec 'SuperAwesome' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'SuperAwesome', '8.3.5'
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'MintegralAdSDK', '~> 7.1.5'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'IronSourceSDK', '7.2.2'
  end
