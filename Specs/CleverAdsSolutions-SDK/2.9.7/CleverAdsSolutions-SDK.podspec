Pod::Spec.new do |s|
  ...
  s.subspec 'UnityAds' do |b|
    ...
    b.vendored_frameworks = 'libs/CASiUnityAdsAdapter.xcframework'
    b.dependency 'CleverAdsSolutions-Base'
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'Ads-Global/BUAdSDK_Compatible', '4.7.0.8'
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'MintegralAdSDK', '~> 7.2.6'
    b.dependency 'MintegralAdSDK/BidSplashAd', '~> 7.2.6'
  end
