Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '~> 10.2.0'
  ...
  s.subspec 'AppLovin' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'AppLovinSDK', '~> 11.8.1'
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'MintegralAdSDK', '~> 7.3.3'
    b.dependency 'MintegralAdSDK/BidSplashAd', '~> 7.3.3'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
