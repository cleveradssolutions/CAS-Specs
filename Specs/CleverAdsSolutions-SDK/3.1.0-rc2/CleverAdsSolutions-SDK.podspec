Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '~> 10.1.0'
  ...
  s.subspec 'AppLovin' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'AppLovinSDK', '~> 11.8.0'
  end
  ...
  s.subspec 'SuperAwesome' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'SuperAwesome', '8.5.6'
  ...
  s.subspec 'Vungle' do |b|
    ...
    b.dependency 'VungleSDK-iOS', '~> 6.12.2'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', "#{s.version}"
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'Ads-Global/BUAdSDK_Compatible', '5.0.0.6'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', "#{s.version}"
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'MintegralAdSDK', '~> 7.3.0'
    b.dependency 'MintegralAdSDK/BidSplashAd', '~> 7.3.0'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
