Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://github.com/cleveradssolutions/CAS-iOS/releases/download/#{s.version}/CleverAdsSolutions.tar.gz", :type => 'tar.gz' }
  s.platform              = :ios, '11.0'
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '~> 10.3.0'
  ...
  s.subspec 'AppLovin' do |b|
    ...
    b.dependency 'AppLovinSDK', '~> 11.8.2'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'SuperAwesome' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base'
    b.dependency 'SuperAwesome', '8.5.7'
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'Ads-Global/BUAdSDK_Compatible', '4.9.1.0'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', "#{s.version}"
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'MintegralAdSDK', '7.3.4'
    b.dependency 'MintegralAdSDK/BidSplashAd', '7.3.4'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  ...
  s.subspec 'DigitalTurbine' do |b|
    ...
    b.dependency 'FairBidSDK', '3.36.0'
    b.dependency 'CleverAdsSolutions-Base'
  end
