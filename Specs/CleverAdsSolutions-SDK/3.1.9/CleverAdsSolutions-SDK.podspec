Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '~> 10.6.0'
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'Ads-Global/BUAdSDK_Compatible', '5.2.1.1'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', "#{s.version}"
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'MintegralAdSDK', '~> 7.3.8'
    b.dependency 'MintegralAdSDK/BidSplashAd', '~> 7.3.8'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
