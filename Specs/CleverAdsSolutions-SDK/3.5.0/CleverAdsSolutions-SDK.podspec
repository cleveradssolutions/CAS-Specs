Pod::Spec.new do |s|
  ...
  s.subspec 'AppLovin' do |b|
    ...
    b.dependency 'AppLovinSDK', '12.1.0'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'Ads-Global/BUAdSDK_Compatible', '5.6.0.7'
    b.dependency 'CleverAdsSolutions-Base'
  end

  s.subspec 'Mintegral' do |b|
    b.vendored_frameworks = 'libs/CASMintegral.xcframework'
    b.dependency 'MintegralAdSDK', '7.5.2'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'DTExchange' do |b|
    ...
    b.dependency 'Fyber_Marketplace_SDK', '8.2.5'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'IronSourceSDK', '7.6.0.0'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'BidMachine' do |b|
    b.vendored_frameworks = 'libs/CASBidMachine.xcframework'
    b.dependency 'BidMachine', '2.4.0.1'
    b.dependency 'CleverAdsSolutions-Base'
  end
