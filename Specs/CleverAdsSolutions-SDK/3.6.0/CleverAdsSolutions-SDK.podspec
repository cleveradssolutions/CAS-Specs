Pod::Spec.new do |s|
  ...
  s.subspec 'AppLovin' do |b|
    ...
    b.dependency 'AppLovinSDK', '12.3.1'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'YandexAds' do |b|
    ...
    b.dependency 'YandexMobileAds', '6.4.1'
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'MintegralAdSDK', '7.5.9'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'IronSourceSDK', '7.9.1.0'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'Madex' do |b|
    ...
    b.dependency 'MadexSDK', '1.2.0'
    b.dependency 'SspnetCore', '1.2.0'
    b.dependency 'CleverAdsSolutions-Base'
  end
