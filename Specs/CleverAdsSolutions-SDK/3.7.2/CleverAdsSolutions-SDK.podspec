Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '11.4.0'
  ...
  s.subspec 'MyTarget' do |b|
    ...
    b.dependency 'myTargetSDK', '5.21.2'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'Ads-Global/BUAdSDK_Compatible', '5.9.0.8'
    b.dependency 'CleverAdsSolutions-Base'
  end

  s.subspec 'Mintegral' do |b|
    b.vendored_frameworks = 'libs/CASMintegral.xcframework'
    b.dependency 'MintegralAdSDK', '7.6.3'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'Madex' do |b|
    ...
    b.dependency 'MadexSDK', '1.3.5'
    b.dependency 'SspnetCore', '1.3.5'
    b.dependency 'SspnetDsp', '1.0.5'
    b.dependency 'CleverAdsSolutions-Base'
  end
