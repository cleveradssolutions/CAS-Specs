Pod::Spec.new do |s|
  ...
  s.subspec 'SuperAwesome' do |b|
    ...
    b.dependency 'SuperAwesome', '9.3.4'
    b.dependency 'CleverAdsSolutions-Base'
  ...
  s.subspec 'YandexAds' do |b|
    ...
    b.dependency 'YandexMobileAds', '7.0.1'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'MintegralAdSDK', '7.6.4'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'DTExchange' do |b|
    ...
    b.dependency 'Fyber_Marketplace_SDK', '8.2.8'
    b.dependency 'CleverAdsSolutions-Base'
  end
