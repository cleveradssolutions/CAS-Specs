Pod::Spec.new do |s|
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '11.5.0'
  ...
  s.subspec 'YandexAds' do |b|
    ...
    b.dependency 'YandexMobileAds', '7.1.0'
    b.dependency 'DivKit', '30.2.0'
    b.dependency 'CleverAdsSolutions-Base'
  end

  s.subspec 'LiftoffMonetize' do |b|
    b.vendored_frameworks = 'libs/CASVungle.xcframework'
    b.dependency 'VungleAds', '7.3.2'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'Ads-Global/BUAdSDK_Compatible', '5.9.0.9'
    b.dependency 'CleverAdsSolutions-Base'
  end

  s.subspec 'Mintegral' do |b|
    b.vendored_frameworks = 'libs/CASMintegral.xcframework'
    b.dependency 'MintegralAdSDK', '7.6.7'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'DTExchange' do |b|
    ...
    b.dependency 'Fyber_Marketplace_SDK', '8.3.0'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'LoopMe' do |b|
    ...
    b.dependency 'LoopMeUnitedSDK', '7.4.19'
    b.dependency 'CleverAdsSolutions-Base'
  end
