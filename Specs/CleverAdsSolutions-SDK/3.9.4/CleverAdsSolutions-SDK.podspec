Pod::Spec.new do |s|
  ...
  s.subspec 'CASExchange' do |b|
    b.dependency 'CleverAdsSolutions-Exchange', '3.9.4'
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '11.10.0'
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'Ads-Global/BUAdSDK_Compatible', '6.2.0.6'
    b.dependency 'CleverAdsSolutions-Base'
  end

  s.subspec 'Mintegral' do |b|
    b.vendored_frameworks = 'libs/CASMintegral.xcframework'
    b.dependency 'MintegralAdSDK', '7.7.2'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'IronSourceSDK', '8.3.0.0'
    b.dependency 'CleverAdsSolutions-Base'
  end
