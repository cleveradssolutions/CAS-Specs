Pod::Spec.new do |s|
  ...
  s.subspec 'CASExchange' do |b|
    b.dependency 'CleverAdsSolutions-Exchange', '3.9.7'
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '11.11.0'
  ...
  s.subspec 'AudienceNetwork' do |b|
    ...
    b.dependency 'FBAudienceNetwork', '6.15.2' # 6.16.0 require update XCode
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'IronSourceSDK', '8.4.0.0'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'Bigo' do |b|
    ...
    b.dependency 'BigoADS', '4.5.1'
    b.dependency 'CleverAdsSolutions-Base'
  end
  
  s.subspec 'Madex' do |b|
    b.vendored_frameworks = 'libs/CASMadex.xcframework'
    b.dependency 'MadexSDK', '1.5.3'
    b.dependency 'SspnetCore', '1.5.4'
    b.dependency 'SspnetDsp', '1.2.3'
    b.dependency 'CleverAdsSolutions-Base'
  end
  ...
  s.subspec 'LoopMe' do |b|
    ...
    b.dependency 'LoopMeUnitedSDK', '7.4.21'
    b.dependency 'CleverAdsSolutions-Base'
  end
