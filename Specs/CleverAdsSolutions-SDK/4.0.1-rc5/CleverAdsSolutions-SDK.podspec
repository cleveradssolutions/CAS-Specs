Pod::Spec.new do |s|
  ...
  s.subspec 'CASExchange' do |b|
    b.dependency 'CleverAdsSolutions-Exchange', '4.0.1-rc5'
  ...
  s.subspec 'GoogleAds' do |b|
    ...
    b.dependency 'Google-Mobile-Ads-SDK', '12.2.0'
  ...
  s.subspec 'AudienceNetwork' do |b|
    ...
    b.dependency 'FBAudienceNetwork', '6.17.1'
  ...
  s.subspec 'Pangle' do |b|
    ...
    b.dependency 'Ads-Global', '6.5.0.9'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  ...
  s.subspec 'Mintegral' do |b|
    ...
    b.dependency 'MintegralAdSDK/BidSplashAd', '7.7.7'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  ...
  s.subspec 'DTExchange' do |b|
    ...
    b.dependency 'Fyber_Marketplace_SDK', '8.3.6'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', "#{s.version}"
  end
  ...
  s.subspec 'Prado' do |b|
    b.vendored_frameworks = 'libs/CASPrado.xcframework'
    b.dependency 'PradoSDK', '10.0.1'
    b.dependency 'CleverAdsSolutions-Base'
  end

  s.subspec 'Bigo' do |b|
    b.vendored_frameworks = 'libs/CASBigo.xcframework'
    b.dependency 'BigoADS', '4.7.0'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  ...
  s.subspec 'YsoNetwork' do |b|
    b.vendored_frameworks = 'libs/CASYsoNetwork.xcframework'
    b.dependency 'YsoNetworkSDK', '1.1.31'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
  
  s.subspec 'Ogury' do |b|
    b.vendored_frameworks = 'libs/CASOgury.xcframework'
    b.dependency 'OgurySdk', '5.0.2'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', "#{s.version}"
  end
