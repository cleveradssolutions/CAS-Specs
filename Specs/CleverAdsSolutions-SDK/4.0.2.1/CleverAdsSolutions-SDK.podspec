Pod::Spec.new do |s|
  ...
  s.subspec 'IronSource' do |b|
    ...
    b.dependency 'CleverAdsSolutions-Base', '4.0.2.1'
  end
  ...
  s.subspec 'Optimal' do |b|
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/AudienceNetwork', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/DTExchange', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/YandexAds', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/Bigo', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/Pangle', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/CASExchange', '4.0.2.1'
  end

  s.subspec 'Families' do |b|
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/Kidoz', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/YandexAds', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/SuperAwesome', '4.0.2.1'
    b.dependency 'CleverAdsSolutions-SDK/DTExchange', '4.0.2.1'
  end
end
