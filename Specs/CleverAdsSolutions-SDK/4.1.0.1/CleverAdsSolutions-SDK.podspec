Pod::Spec.new do |s|
  ...
  s.subspec 'Optimal' do |b|
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/AudienceNetwork', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/DTExchange', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/YandexAds', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/Bigo', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/Pangle', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/CASExchange', '4.1.0.1'
  end

  s.subspec 'Families' do |b|
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/Kidoz', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/YandexAds', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/SuperAwesome', '4.1.0.1'
    b.dependency 'CleverAdsSolutions-SDK/DTExchange', '4.1.0.1'
  end
end
