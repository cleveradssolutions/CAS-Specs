Pod::Spec.new do |s|
  ...
  s.subspec 'IronSource' do |b|
    b.dependency 'CASMediationIronSource', '8.9.1.1'
  ...
  s.subspec 'GoogleAds' do |b|
    b.dependency 'CASMediationGoogleAds', '12.6.0.1'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end
  ...
  s.subspec 'Chartboost' do |b|
    b.dependency 'CASMediationChartboost', '9.9.0.1'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end
  ...
  s.subspec 'Kidoz' do |b|
    b.dependency 'CASMediationKidoz', '10.0.3.0'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end

  s.subspec 'Mintegral' do |b|
    b.dependency 'CASMediationMintegral', '7.7.8.1'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end

  s.subspec 'AppLovin' do |b|
    b.dependency 'CASMediationAppLovin', '13.3.1.0'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end

  s.subspec 'Pangle' do |b|
    b.dependency 'CASMediationPangle', '7.2.0.5.0'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end

  s.subspec 'Bigo' do |b|
    b.dependency 'CASMediationBigo', '4.8.0.1'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end

  s.subspec 'YandexAds' do |b|
    b.dependency 'CASMediationYandexAds', '7.14.0.0'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end

  s.subspec 'AudienceNetwork' do |b|
    b.dependency 'CASMediationAudienceNetwork', '6.20.0.1'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end
  ...
  s.subspec 'HyprMX' do |b|
    b.dependency 'CASMediationHyprMX', '6.4.2.2'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end
  ...
  s.subspec 'Prado' do |b|
    b.dependency 'CASMediationPrado', '10.0.3.0'
    b.dependency 'CleverAdsSolutions-Base', '4.1.2'
  end
  ...
  s.subspec 'Optimal' do |b|
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/AudienceNetwork', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/AppLovin', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/DTExchange', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/IronSource', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/YandexAds', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/Bigo', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/Pangle', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/CASExchange', '4.1.2'
  end

  s.subspec 'Families' do |b|
    b.dependency 'CleverAdsSolutions-SDK/GoogleAds', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/LiftoffMonetize', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/Kidoz', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/Chartboost', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/UnityAds', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/InMobi', '4.1.2'
    b.dependency 'CleverAdsSolutions-SDK/Mintegral', '4.1.2'
